...
public:
    Simulated_Annealing(int n_particles, int rank, int max_iter, std::vector<float> &min_pos, std::vector<float> &max_pos,
                        float temperature, float temp_min, float cooling_factor);
